      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('admin-task')}}"><i class="fa fa-circle-o"></i>Task</a></li>
            <li class='active'><a href="{{url('/adminpanel/about/company')}}"><i class="fa fa-circle-o"></i>About</a></li>
          </ul>
        </li>
